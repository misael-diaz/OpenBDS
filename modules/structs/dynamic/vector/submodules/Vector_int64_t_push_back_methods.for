!
!   source: Vector_int64_t_push_back_methods.for
!   author: misael-diaz
!   date:   2021-06-27
!
!
...
submodule (VectorClass) vector_int64_t_push_back_methods
implicit none
contains
  ...
  module subroutine vector_int64_t_push_back_array (vector, array)
      ! Synopsis: Pushes 64-bit integer array unto back of vector.
      type(vector_t), intent(inout) :: vector
      integer(kind = int64), intent(in) :: array(:)
  ...
  module pure subroutine vector_int64_t_push (vector, value)
      ...
      return
  end subroutine vector_int64_t_push
  ...
  module subroutine vector_int64_t_createArray (vector, array)
      ...
      return
  end subroutine vector_int64_t_createArray
