!
!   source: Vector_pointer_t_implementations.for
!   author: misael-diaz
!   date:   2021-10-25
!
!
!   Synopsis:
!   Implements the push-back method of the pointer type.
!
!
...
submodule (VectorClass) vector_pointer_t_push_back_methods
implicit none
contains
  ...
  module subroutine vector_pointer_t_push_back (vector, value)
      ! Synopsis: Pushes pointer unto back of vector.
  ...
  module subroutine vector_pointer_t_push_back_array (vector, array)
      ! Synopsis: Pushes pointer array unto back of vector.
      type(vector_t), intent(inout) :: vector
      type(pointer_t), intent(in) :: array(:)
  ...
  module subroutine vector_pointer_t_push (vector, value)
      ...
      return
  end subroutine vector_pointer_t_push
  ...
  module subroutine vector_pointer_t_push_array (vector, array)
      ...
      return
  end subroutine vector_pointer_t_push_array
  ...
  module subroutine vector_pointer_t_push_n_copies (vector, n, value)
      ...
      return
  end subroutine vector_pointer_t_push_n_copies
  ...
  module subroutine vector_pointer_t_grow (vector, value)
      ...
      type(vector_t), intent(inout) :: vector
      type(pointer_t), intent(in) :: value
      type(pointer_t), allocatable :: array(:)
      ...
      return
  end subroutine vector_pointer_t_grow
  ...
  module subroutine vector_pointer_t_backup (vector, array)
      ...
      return
  end subroutine vector_pointer_t_backup
  ...
  module subroutine vector_pointer_t_restore (vector, array, value)
      ...
      return
  end subroutine vector_pointer_t_restore
  ...
  module subroutine vector_pointer_t_create (vector, value)
      ...
      type(pointer_t), intent(in) :: value
      character(len=*), parameter :: errmsg = &
          & "dynamic::vector.error: container of pointers"
      ...
      return
  end subroutine vector_pointer_t_create
  ...
  module subroutine vector_pointer_t_createArray (vector, array)
      ...
      return
  end subroutine vector_pointer_t_createArray
