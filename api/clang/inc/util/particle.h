...
#define util_particle_translate(particles, FORCE, ...)\
	util_particle_translate_varg(particles, FORCE, (struct mobility) { __VA_ARGS__ })
...
void util_particle_translate_varg(particle_t*, enum FORCE, struct mobility);
