...
c         Synopsis:
c         Applies periodic boundary conditions to a position vector component.
        ...
        pure subroutine apply_periodic_boundary_conditions (x, y, z)
c         Synopsis:
c         Applies periodic boundary conditions on the position vector components.
          real(kind = real64), intent(inout) :: x(N)
        ...
        pure subroutine pbc (particles)
c         Synopsis:
c         Applies periodic boundary conditions on the position vectors of the particles.
          ...
          call apply_periodic_boundary_conditions(x, y, z)
...
*
*   Synopsis:
*   Implements methods for applying periodic boundary conditions.
*
